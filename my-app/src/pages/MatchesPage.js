...
const mentorProfiles = [
  {
    ...
    expertise: ['Backend Architecture', 'Observability', 'Mentoring engineering teams'],
    mentoringTopics:
    ...
    funFact: 'Collects vintage synthesizers and makes ambient music on weekends.',
  },
  {
    id: 'mentor-celine',
    name: 'Celine Park',
    ...
    funFact: 'Runs a neighborhood supper club sourcing ingredients from local urban farms.',
  },
  {
    id: 'mentor-omar',
    name: 'Omar Siddiqui',
    ...
    funFact: 'Certified barbecue judge who travels for smokehouse competitions.',
  },
  {
    id: 'mentor-lucia',
    ...
    expertise: ['Leadership Development', 'Hiring Playbooks', 'Career Frameworks'],
    mentoringTopics:
...
const menteeProfiles = [
  {
    ...
    funFact: 'I host a Sunday dinner club that experiments with regional noodle recipes.',
  },
  {
    id: 'mentee-raj',
    name: 'Raj Mehta',
    ...
    funFact: 'Weekend guitarist who performs at open mic nights around the city.',
  },
  {
    id: 'mentee-alia',
    name: 'Alia Hussein',
    ...
    funFact: 'I completed a freediving certification and love underwater photography.',
  },
  {
    id: 'mentee-luca',
    name: 'Luca Romano',
...
function MatchesPage() {
  ...
  const userRole = roleFromState === 'mentor' ? 'mentor' : roleFromState === 'mentee' ? 'mentee' : 'mentee';
